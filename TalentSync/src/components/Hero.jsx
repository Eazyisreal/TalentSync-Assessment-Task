...
import Avatar from "../assets/images/avatar-group.svg"
...
import Mircophone from "../assets/images/microphone.svg"
import Monitor from '../assets/images/monitor.svg'
import Muslim from "../assets/images/muslimwoman.svg"
import Oldman from "../assets/images/oldman.svg"
import Settings from "../assets/images/settings.svg"
import Smiley from "../assets/images/face-smile.svg"
import SmilingMan from "../assets/images/smilingman.svg"
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="flex items-center gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                ...
                                <path d="M17.9575 12.2538C17.9576 11.118 17.9613 10.0031 17.9541 8.88831C17.9529 8.70085 18.0042 8.63472 18.1997 8.63604C18.5028 8.63808 18.7995 8.65679 19.0785 8.78075C19.676 9.04617 19.9738 9.5285 19.9869 10.1637C20.0073 11.1528 20.0016 12.1426 19.9897 13.1319C19.9791 14.0027 19.3085 14.6507 18.4321 14.651C17.8764 14.6513 17.9634 14.7273 17.9589 14.177C17.9537 13.5429 17.9576 12.9088 17.9575 12.2538Z" fill="#175CD3" />
                                <path d="M7.18439 10.8826C6.30831 10.6563 5.95708 9.60443 6.49951 8.87652C6.86572 8.38509 7.54175 8.25075 8.11797 8.53854C8.61749 8.78803 8.88209 9.44916 8.71367 10.0269C8.54707 10.5985 7.98614 10.9754 7.38664 10.9173C7.32448 10.9113 7.26312 10.897 7.18439 10.8826Z" fill="#175CD3" />
                                <path d="M13.7153 9.94561C13.513 10.8954 12.3155 11.2594 11.5976 10.5618C11.2151 10.19 11.121 9.5618 11.3775 9.03621C11.5806 8.61991 12.1592 8.32903 12.6447 8.39914C13.2114 8.48098 13.6178 8.87095 13.7227 9.41302C13.7568 9.58872 13.757 9.75679 13.7153 9.94561Z" fill="#175CD3" />
                                <path d="M7.8998 14.4796C7.77567 14.6078 7.63491 14.6534 7.47486 14.6527C7.15519 14.6514 6.83545 14.6561 6.51585 14.6512C6.18533 14.6462 5.99046 14.4496 5.9922 14.1338C5.9939 13.8244 6.19505 13.6275 6.52577 13.6223C6.83147 13.6174 7.13734 13.6183 7.44307 13.6221C7.95291 13.6284 8.17162 14.0269 7.8998 14.4796Z" fill="#175CD3" />
